...
thread_addThreadDescription("CAN", 10, 10, 0, 254, CORE0, SYSTEM_PARTITION);\
thread_addThreadDescription("EKF", 15, 15, 0, 252, CORE3, SYSTEM_PARTITION);\
thread_addThreadDescription("Lidar", 33, 33, 0, 251, CORE0, SYSTEM_PARTITION);\
thread_addThreadDescription("Detection", 200, 200, 0, 248, CORE2, SYSTEM_PARTITION);\
thread_addThreadDescription("Localization", 400, 400, 0, 247, CORE1, SYSTEM_PARTITION);\
