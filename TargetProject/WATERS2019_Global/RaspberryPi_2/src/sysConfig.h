...
thread_addThreadDescription("Control", 5, 5, 0, 255, CORE0|CORE1|CORE2|CORE3, SYSTEM_PARTITION);\
thread_addThreadDescription("Lane_Detection", 66, 66, 0, 249, CORE1|CORE2|CORE3|CORE0, SYSTEM_PARTITION);\
thread_addThreadDescription("SFM", 33, 33, 0, 250, CORE2|CORE3|CORE1|CORE0, SYSTEM_PARTITION);\
thread_addThreadDescription("Planner", 15, 15, 0, 253, CORE3|CORE2|CORE1|CORE0, SYSTEM_PARTITION);\
