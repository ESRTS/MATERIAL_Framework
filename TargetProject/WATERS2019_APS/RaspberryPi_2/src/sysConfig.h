...
aps_add_partition_description("N2_P0", 200, 1);\
aps_add_partition_description("N2_P1", 250, 1);\
aps_add_partition_description("N1_P2", 250, 1);\
aps_add_partition_description("N1_P3", 250, 1);\
...
thread_addThreadDescription("Control", 5, 5, 0, 255, CORE1, N2_P0);\
thread_addThreadDescription("Lane_Detection", 66, 66, 0, 249, CORE0, N2_P1);\
thread_addThreadDescription("SFM", 33, 33, 0, 250, CORE2, N1_P2);\
thread_addThreadDescription("Planner", 15, 15, 0, 253, CORE3, N1_P3);\
