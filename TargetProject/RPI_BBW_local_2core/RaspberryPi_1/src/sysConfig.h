...
thread_addThreadDescription("pBrakePedalLDM", 20, 10, 0, 250, CORE0|CORE1, SYSTEM_PARTITION);\
thread_addThreadDescription("pBrakeTorqueMap", 30, 10, 0, 249, CORE0|CORE1, SYSTEM_PARTITION);\
thread_addThreadDescription("pGlobalBrakeController", 40, 10, 0, 248, CORE0|CORE1, SYSTEM_PARTITION);\
thread_addThreadDescription("ABS_FL_Pt", 50, 10, 0, 247, CORE0|CORE1, SYSTEM_PARTITION);\
thread_addThreadDescription("pLDM_Brake_FL", 60, 10, 0, 243, CORE0|CORE1, SYSTEM_PARTITION);\
thread_addThreadDescription("ABS_FR_Pt", 50, 10, 0, 246, CORE0|CORE1, SYSTEM_PARTITION);\
thread_addThreadDescription("pLDM_Brake_FR", 60, 10, 0, 242, CORE0|CORE1, SYSTEM_PARTITION);\
thread_addThreadDescription("ABS_RL_Pt", 50, 10, 0, 245, CORE0|CORE1, SYSTEM_PARTITION);\
thread_addThreadDescription("pLDM_Brake_RL", 60, 10, 0, 241, CORE0|CORE1, SYSTEM_PARTITION);\
thread_addThreadDescription("ABS_RR_Pt", 50, 10, 0, 244, CORE0|CORE1, SYSTEM_PARTITION);\
thread_addThreadDescription("pLDM_Brake_RR", 60, 10, 0, 240, CORE0|CORE1, SYSTEM_PARTITION);\
